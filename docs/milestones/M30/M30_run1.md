...
**`v0.0.30-m30`** — message `M30: QA / evidence publishing`. Annotates the **final M30 closeout** commit on **`main`** (after **PR #82** merge **`b663f735`**); verify with `git show v0.0.30-m30`.
