...
| M40 | Coverage wave on legacy/high-value modules | **Completed** | `m40-coverage-wave-legacy-modules` (+ recovery) | **[#96](https://github.com/m-cahill/serena/pull/96)**–**[#100](https://github.com/m-cahill/serena/pull/100)** | merge **`15dcdb59ce0d7a04943102c55820703f623b46a5`** (final); **#96** merge **`75f9bb33`** | PR **#96** Linter **`23721581850`**, Smoke **`23721581839`** (head **`696971ce`**); **main** Linter **`23722341896`**, Quality **`23722341901`** (**243** pass, **49%**); gate **42%** unchanged | **`M40_run1.md`**, **`M40_summary.md`**, **`M40_audit.md`** | **2026-03-30T00:07:07Z** UTC |
| M41 | Performance SLOs and regression guardrails | **Planned** | — | — | — | — | — | — |
