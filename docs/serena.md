...
| M18 | Decode/save separation | PR open — Linter + Smoke green; Quality on merge | m18-decode-save-separation | #36 | 2f6e3e2a | Linter 23320455954 ✓ (push); Linter 23320478855 ✓; Smoke 23320478834 ✓ (PR); Quality pending `main` push | — | — |
