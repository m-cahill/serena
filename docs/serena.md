...
| M39 | Remaining legacy surface narrowing | **PR open** | `m39-remaining-legacy-surface-narrowing` | **[#95](https://github.com/m-cahill/serena/pull/95)** | **`c83e14cd`** | PR: Linter **`23719231700`**, Smoke **`23719231692`**; post-merge Quality — **`M39_run1.md`** | **`_eff_opts`**, allowed-legacy §2.2 | — |
| M40 | Coverage wave on legacy/high-value modules | **Planned** | — | — | — | — | — | — |
| M41 | Performance SLOs and regression guardrails | **Planned** | — | — | — | — | — | — |
