...
| M39 | Remaining legacy surface narrowing | **PR open** | `m39-remaining-legacy-surface-narrowing` | **[#95](https://github.com/m-cahill/serena/pull/95)** | **`d0bb6afa`** | PR: Linter **`23719373729`**, Smoke **`23719373734`**; post-merge Quality — **`M39_run1.md`** | **`_eff_opts`**, allowed-legacy §2.2 | — |
| M40 | Coverage wave on legacy/high-value modules | **Planned** | — | — | — | — | — | — |
| M41 | Performance SLOs and regression guardrails | **Planned** | — | — | — | — | — | — |
