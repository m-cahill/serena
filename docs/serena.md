...
| M18 | Decode/save separation | PR open — Linter + Smoke green; Quality on merge | m18-decode-save-separation | #36 | 5c4613f5 | Linter 23320583095 ✓ (push); Linter 23320584761 ✓; Smoke 23320584759 ✓ (PR); Quality pending `main` push | — | — |
