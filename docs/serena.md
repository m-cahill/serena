...
| M34 | Runtime context model-identity seam | In progress | m34-runtime-context-model-identity | — | — | — | **`ModelIdentity`** on **`RuntimeContext`**; see **`docs/milestones/M34/M34_plan.md`** | — |
