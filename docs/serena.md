...
**M32 ? Evidence/audit closure** **complete** — **PR #86** → merge **`3f6f6a2e`** (2026-03-27 ~00:06 UTC); **`M32_run1.md`**, **`M32_summary.md`**, **`M32_audit.md`**; bundle/matrix index updates; **doc-only**. **Next:** **M33** (release-ready 5/5 close).
