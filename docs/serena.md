...
**Program status (2026-03-30 UTC):** **Phase IX complete.** **M41** is the **final** planned Serena milestone; optional **M42** remains **conditional** on upstream PyPI fixes for documented **`pip-audit`** deferrals (see ledger).
...
| M39 | Remaining legacy surface narrowing | **Complete** (2026-03-29 UTC) |
| M40 | Coverage wave on legacy/high-value modules | **Complete** (2026-03-30T00:07:07Z UTC) |
| M41 | Performance SLOs and regression guardrails | **Complete** (2026-03-30T05:07:26Z UTC) |

**Progress (Phase IX):** **Phase IX complete (M38–M41).** **M38** — **`processing_types` / `processing_helpers` / `processing_infotext`** split; **PR [#94](https://github.com/m-cahill/serena/pull/94)** merge **`17c21be669942518ab4683ba504c87c1ad58900e`**; **main** Quality **`23700723134`** (**217** pass, **48%**). **M39** — **`_eff_opts(p)`** / **`_EffOptsView`**; **PR [#95](https://github.com/m-cahill/serena/pull/95)** merge **`d4551e6d55c31c5f6b1efd0a5d04956a19d0ea53`** (**2026-03-29T21:45:43Z**); approval head **`0aa0d93d`** (Linter **`23719443302`**, Smoke **`23719443311`**); binding **`main`** Quality **`23719932254`** @ **`1b9f304e`** (**222** pass, **48%**); **`docs/milestones/M39/`** closeout. **M40** — Quality tests for **`processing_helpers`**, **`processing_infotext`**, **`processing_types`**, **`processing_runtime`**; **PR [#96](https://github.com/m-cahill/serena/pull/96)** merge **`75f9bb33`** (approval head **`696971ce`**); recovery **PRs [#97](https://github.com/m-cahill/serena/pull/97)–[#100](https://github.com/m-cahill/serena/pull/100)** (collection-order / assertion fixes); binding **`main`** Quality **`23722341901`** @ **`15dcdb59ce0d7a04943102c55820703f623b46a5`** (**243** pass, **49%**); gate **42%** unchanged; doc closeout **[PR #101](https://github.com/m-cahill/serena/pull/101)** merge **`e07b31edcd58e1bf9a99887a8fef7058e5dce15d`** — post-merge **`main`** Quality **`23722553628`** (**243** pass, **49%**); **`docs/milestones/M40/`**. **M41** — warn-first performance regression check vs committed baseline; workflow permissions; Nightly **`pip-audit`** alignment; README / **`opts_snapshot`** / narrow **`ValueError`**; **PR [#103](https://github.com/m-cahill/serena/pull/103)** merge **`8e7736f0b53c93fe13f0aab4e3cc7d188acc2408`**; approval head **`5efdcc83`**; Linter **`23728560305`**, Smoke **`23728560308`**; binding **`main`** Quality **`23728637285`** (**246** pass, **49%**); gate **42%** unchanged; **`docs/milestones/M41/`** closeout.
...
| M39 | Remaining legacy surface narrowing | **Completed** | `m39-remaining-legacy-surface-narrowing` | **[#95](https://github.com/m-cahill/serena/pull/95)** | merge **`d4551e6d55c31c5f6b1efd0a5d04956a19d0ea53`**; binding **`main`** **`1b9f304e`** | PR approval **`0aa0d93d`**: Linter **`23719443302`**, Smoke **`23719443311`**; **main:** Linter **`23719932253`**, Quality **`23719932254`** (**222** pass, **48%**); merge-first Quality **`23719815660`** fail → fix **`1b9f304e`** — **`M39_run1.md`** | **`_eff_opts`**, allowed-legacy §2.2 | **2026-03-29 UTC** |
| M40 | Coverage wave on legacy/high-value modules | **Completed** | `m40-coverage-wave-legacy-modules` (+ recovery) | **[#96](https://github.com/m-cahill/serena/pull/96)**–**[#101](https://github.com/m-cahill/serena/pull/101)** | code merge **`15dcdb59ce0d7a04943102c55820703f623b46a5`**; **#96** merge **`75f9bb33`**; doc **`e07b31edcd58e1bf9a99887a8fef7058e5dce15d`** | PR **#96** Linter **`23721581850`**, Smoke **`23721581839`** (head **`696971ce`**); **main** Linter **`23722341896`**, Quality **`23722341901`** (**243** pass, **49%**); doc **#101** Quality **`23722553628`**; gate **42%** unchanged | **`M40_run1.md`**, **`M40_summary.md`**, **`M40_audit.md`** | **2026-03-30T00:07:07Z** UTC |
| M41 | Performance SLOs and regression guardrails | **Completed** | `m41-performance-guardrails-final-polish` + `m41-closeout-docs` | **[#103](https://github.com/m-cahill/serena/pull/103)** / **[#104](https://github.com/m-cahill/serena/pull/104)** | **`8e7736f0`** (impl); **`4cccde03`** (ledger + closeout) | **#103:** PR Linter **`23728560305`**, Smoke **`23728560308`**; **main** Quality **`23728637285`** (**246**, **49%**). **#104:** PR Linter **`23728811492`**, Smoke **`23728811530`**; **main** Quality **`23728891097`** | **`M41_run1.md`**, **`M41_summary.md`**, **`M41_audit.md`** | **2026-03-30T05:07:26Z** UTC |
...
**M38:** **`processing.py` class and helper decomposition** — **PR [#94](https://github.com/m-cahill/serena/pull/94)** merge **`17c21be669942518ab4683ba504c87c1ad58900e`**; **`processing_types`**, **`processing_helpers`**, **`processing_infotext`**; **`processing.py`** orchestration + re-exports. **`M38_run1.md`**, **`M38_summary.md`**, **`M38_audit.md`**.

**M39:** **Remaining legacy surface narrowing** — **PR [#95](https://github.com/m-cahill/serena/pull/95)** merge **`d4551e6d55c31c5f6b1efd0a5d04956a19d0ea53`** (**2026-03-29T21:45:43Z**); approval head **`0aa0d93d4df894aaef841c0c0f425c75ab3ba8d6`** — Linter **`23719443302`**, Smoke **`23719443311`**. **`_eff_opts(p)`** / **`_EffOptsView`** in **`processing_helpers.py`** — snapshot-first reads with **`shared.opts`** fallback for missing snapshot keys; direct **`shared.opts`** removed from **`processing_types.py`**, **`processing_infotext.py`**, **`processing.py`** overlay branch, **`processing_runtime.py`** preview gate; **`create_opts_snapshot(shared.opts)`** unchanged; **`StableDiffusionProcessing.sd_model`** unchanged. Post-merge Quality on merge commit failed (sparse test **`opts_snapshot`**); follow-up **`main`** **`1b9f304e`** — Quality **`23719932254`** (**222** pass, **48%**). **`docs/milestones/M39/`**; **`serena_allowed_legacy_surfaces.md`** §2.2.

**M40:** **Coverage wave on legacy/high-value modules** — **PR [#96](https://github.com/m-cahill/serena/pull/96)** merge **`75f9bb33`** (approval head **`696971ce`**); recovery **PRs [#97](https://github.com/m-cahill/serena/pull/97)–[#100](https://github.com/m-cahill/serena/pull/100)** (no production code — deferred imports + test assertions). Binding **`main`** merge **`15dcdb59ce0d7a04943102c55820703f623b46a5`** — Linter **`23722341896`**, Quality **`23722341901`** (**243** pass, **49%** TOTAL pytest-only); coverage gate **42%** unchanged. **`docs/milestones/M40/`** (`M40_run1.md`, `M40_summary.md`, `M40_audit.md`).

**M41:** **Performance SLOs and regression guardrails (final Phase IX)** — **PR [#103](https://github.com/m-cahill/serena/pull/103)** merge **`8e7736f0b53c93fe13f0aab4e3cc7d188acc2408`** (approval head **`5efdcc83`**): warn-first **`check_performance_regression.py`** + committed baseline; explicit workflow **`permissions`**; Nightly **`pip-audit`** alignment; README Serena block; **`opts_snapshot`** header; **`ValueError`** for missing refiner checkpoint. PR CI: Linter **`23728560305`**, Smoke **`23728560308`**. Binding **`main`** Quality **`23728637285`** (**246** pass, **49%**); performance step **non-blocking**. **Doc closeout [PR #104](https://github.com/m-cahill/serena/pull/104)** merge **`4cccde03e6714e039ca9b4470898c7d0b0df6421`** — ledger + **`M41_summary` / `M41_audit` / binding `M41_run1`**; post-merge Quality **`23728891097`**. **`docs/milestones/M41/`** — **`M41` closes the Serena refactor program** (optional **M42** conditional on PyPI deferral fixes only).
