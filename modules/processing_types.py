"""StableDiffusion processing dataclasses (M38 extraction from processing.py)."""
...
from modules import devices, extra_networks, prompt_parser, masking, sd_samplers, lowvram, scripts, sd_samplers_common, rng
...
from modules.runtime import sampler_runtime, decode_runtime
